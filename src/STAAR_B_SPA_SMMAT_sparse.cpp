...
// [[Rcpp::export]]
arma::vec STAAR_B_SPA_SMMAT_sparse(arma::mat G, arma::mat XW, arma::mat XXWX_inv, arma::vec residuals, arma::vec muhat, arma::mat weights_B, double tol, int max_iter,
double p_filter_cutoff, arma::sp_mat G_sp, arma::sp_mat Sigma_i, arma::mat Sigma_iX, arma::mat cov)
{
	int i,k;
	double sum0 = 0.0;
	...
	tSigma_iX_G = trans(Sigma_iX)*G_sp;
	Cov = trans(Sigma_i*G_sp)*G_sp - trans(tSigma_iX_G)*cov*tSigma_iX_G;
